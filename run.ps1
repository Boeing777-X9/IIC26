# RetinaGrid / IIC26 Development Server Launcher for Windows PowerShell
...
Write-Host "   Starting RetinaGrid Development Servers...       " -ForegroundColor Yellow
Write-Host "=================================================" -ForegroundColor Cyan
...
Write-Host "Starting RetinaGrid frontend on http://localhost:3000..." -ForegroundColor Cyan
try {
    npm run dev
} finally {
